...
>>>>>>> fixed the db model to have a fixedName property which will be the name property stripped of spaced. This will modals and such that use the categories for IDs
